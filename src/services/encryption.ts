...
/**
 * Generate the decryption JavaScript code for the recovery HTML page
 * This is embedded in the generated HTML so it can decrypt client-side
 */
export function getDecryptionScript(): string {
  return `
// Web Crypto decryption for backup recovery
